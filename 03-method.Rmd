...
**Tráfico por Año**
El tráfico año por año va incrementando
...
El tráfico al verlo en una grafica circular se  puede ver como el gráfico crece año tras año 
...
**Box Plot** podemos apreciar una tendencia creciente  mirando el diagrama de cajas , la unica diferencia es en 2024 ya que tiene pocos meses
...
**Histograma* no se puede observar  ningun tipo de distribución en el gráfico
...
```
**Densidad* podemos ver un gráfico parecido al histograma per suavizado
...
Aca podemos observar la autocorrelacion entre los datos observados actuales versus 1  dato anterior(lag)
